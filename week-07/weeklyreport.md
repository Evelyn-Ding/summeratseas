...
- For the ARNI project, Thai recommended that I read the paper [Attention is all you need](https://arxiv.org/pdf/1703.01365) to better understand encoder/decoder models (& classification heads). I'm also eager to learn more about the architectures like BERT, HuBERT (BERT fine-tuned for Automatic Speech Recognition), Transformers, RNNs. I can also work on properly implementing SHAP, which will require me to try fixing dependencies. Finally, I'll look for a multimodal dataset on mental health disorders that offers both text and speech data.
- I am working on the following IRB trainings: TC0019 - HIPAA: Health Insurance Portability Accountability Act Research Training Course; TC0087 - Human Subjects Protection Training (includes Minors and FDA where applicable). I'll document the training process as I complete them.
