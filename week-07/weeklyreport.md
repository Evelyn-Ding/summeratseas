...
- The first step was feature extraction. I had a couple ideas last week for which set of features to extract: ```(1) eGeMAPS (2) NeuroSpeech (3) MDVP (Multidimensional Voice Program)```. The reason why I want to try extracting feature sets is that I plan on comparing their accuracies!
