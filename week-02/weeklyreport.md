...
- I noticed that the primary mental health disorders that fit my criteria were schizophrenia/bipolar and depression/MDD. I generated this [brief report](https://github.com/Evelyn-Ding/summeratseas/blob/main/week-02/publicspeechdata.md) where I went through the section broken down by disorder and looked at each citation to see if the dataset (either proposed/given by the paper or used/accessed by the authors) was publicly available. I found the most potential in the dementia/Alzheimer's datasets.
